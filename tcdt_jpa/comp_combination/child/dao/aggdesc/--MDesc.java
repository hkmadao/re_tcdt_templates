...
import com.cft.mdc.base.AggBaseDesc;
import com.cft.mdc.base.desc.AttributeInfo;
import com.cft.mdc.base.desc.EntityInfo;
import com.cft.mdc.base.desc.JoinInfo;
import com.cft.mdc.base.enums.EDataType;
...
{%- if rootInfo.attributeInfoList is iterable %}
    ...
    private final AttributeInfo {{ attributeInfo.camelCaseName }}Desc() {
        ...
        attributeInfo.setDisplayName("{{ attributeInfo.displayName }}{%- if attributeInfo.note %}:{{ attributeInfo.note }}{%- else %}{%- endif %}");
