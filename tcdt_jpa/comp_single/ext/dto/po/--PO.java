...
package {{ rootInfo.mainEntityInfo.basePath }}.{{ rootInfo.mainEntityInfo.packageName }}.dto.po;
{%- endif %}
{%- if rootInfo.fgMain %}
...
import {{ upAttributeInfo.outEntityInfo.basePath }}.{{ upAttributeInfo.outEntityInfo.packageName}}.dto.po.{{ upAttributeInfo.outEntityInfo.className}}PO;
    {%- endif %}
{%- endfor %}
